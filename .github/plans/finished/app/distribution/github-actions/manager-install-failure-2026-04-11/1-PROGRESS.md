...
- [x] `pyproject.toml` publishes the real repository URL consistently
- [x] Documentation no longer contradicts the published install path
...
- [x] Narrow validation confirms the corrected URL resolves and matches repo origin
...
| 2026-04-11 | User Confirmation | ✅ PASS | User confirmed the Manager install now works |
...
- User validation confirmed the fix worked in the actual ComfyUI-Manager install flow.
