...
from .load_image_url_node import (
    NODE_CLASS_MAPPINGS as _IMAGE_URL_CLASSES,
    NODE_DISPLAY_NAME_MAPPINGS as _IMAGE_URL_NAMES,
)
...
NODE_CLASS_MAPPINGS = {**_VIDEO_URL_CLASSES, **_IMAGE_URL_CLASSES, **_EVENT_EMITTER_CLASSES}
NODE_DISPLAY_NAME_MAPPINGS = {**_VIDEO_URL_NAMES, **_IMAGE_URL_NAMES, **_EVENT_EMITTER_NAMES}
